...
<div class="sv_shadow-lg my-4">
    <div class="sv_container-fluid  sv_sv_text-dark sv_rounded-top" style="background: url('<?php echo  SHIPVISTA__PLUGIN_URL . 'assets/img/bg2.jpg' ?>')no-repeat top !important;background-size:cover; background-blend-mode:opacity; width: 100%;">
        ...
        <div class=" sv_row sv_border-bottom sv_d-100 sv_p-3 sv_sv_py-4">
            <div class="sv_col-12 sv_col-md-4 sv_text-center  sv_mb-3 sv_mb-md-0">
                <img src="<?php echo  SHIPVISTA__PLUGIN_URL . 'assets/img/shipvista_logo.png' ?>" style="height: 80px;" class=" mr-2">
                ...
                <div class="sv_col-12 sv_col-md-3 sv_col-lg-2 p-0" style="background: #cecece99">
                    ...
                    <ul class="sv_nav sv_d-none sv_d-md-block sv_flex-column" id="whipvistanavigation_menu">
                        ...
                        <li class="sv_nav-item">
                            <a class="sv_nav-link  <?php echo ($this->activePage == 'connect' ? ' sv_bg-dark sv_text-white ' : ' sv_text-dark ') ?>" href="<?php echo $this->pageLink . '&wcs_page=connect' ?>">Home</a>
                        </li>

                        <li class="sv_nav-item">
                            <a class="sv_nav-link  <?php echo ($this->activePage == 'carriers' ? ' sv_bg-dark sv_text-white ' : ' sv_text-dark ') ?>" href="<?php echo $this->pageLink . '&wcs_page=carriers' ?>">Carriers</a>
                        </li>
                        <li class="sv_nav-item d-none">
                            <a class="sv_nav-link  <?php echo ($this->activePage == 'sipping' ? ' sv_bg-dark sv_text-white ' : ' sv_text-dark ') ?>" href="<?php echo $this->pageLink . '&wcs_page=shipping' ?>">Labels</a>
                        </li>
                        <li class="sv_nav-item">
                            <a class="sv_nav-link  <?php echo (($this->activePage == 'settings' && (!isset($_GET['wcs_setting']) ||  $_GET['wcs_setting'] != 'feedback')) ? ' sv_bg-dark sv_text-white ' : ' sv_text-dark ') ?> " href="<?php echo $this->pageLink . '&wcs_page=settings' ?>">Settings</a>
                        </li>
                        <li class="sv_nav-item">
                            <a class="sv_nav-link  <?php echo ((isset($_GET['wcs_setting']) == 'wc' && $_GET['wcs_setting'] == 'feedback') ? ' sv_bg-dark sv_text-white ' : ' sv_text-dark ') ?> " href="<?php echo $this->pageLink .  '&wcs_page=settings&wcs_setting=feedback'  ?>">Send Feedback</a>
                        </li>
